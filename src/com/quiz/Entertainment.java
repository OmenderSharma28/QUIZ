		...
		if((v.getId()==R.id.option1 ))
		{
			...
			if(radioButton1.isChecked()){
				...
				if(ans.equals(answer))
				{
					...
					View toastRoot = inflater.inflate(R.layout.greentoast, null);
					
					Toast toast = new Toast(context);
//					String str="You Tick Worng Answere. The Right Answer is ";
...
//				LayoutInflater inflater = getLayoutInflater();
////				View layout = inflater.inflate(R.layout.mytoast,(ViewGroup) findViewById(R.id.root_layout));
//				
